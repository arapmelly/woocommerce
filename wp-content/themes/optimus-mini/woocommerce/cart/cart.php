...
<div class="cart-item-list">
	...
	if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
		...
		?>
            ...
            <ul class="single-cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
		...
		$image = get_product_primary_image($_product);

		?>

                        	<?php if (!is_null($image)) {?> <img src="<?php echo $image->small; ?>" alt=""> <?php } else {?>
