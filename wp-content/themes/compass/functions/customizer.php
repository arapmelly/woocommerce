    ...
    public static function Compass_Settings() {
        $compass_settings = array(
           ...
           'compass_slideimage1' => array(
            ...
            'compass_facebook' => array(
                'id' => 'compass_options[compass_facebook]',
                'label' => __('Facebook URL', 'compass'),
                'description' => __('Mention the URL of your Facebook Feed here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            ...
            'compass_pinterest' => array(
               ...
               'compass_google' => array(
                'id' => 'compass_options[compass_google]',
                'label' => __('Google URL', 'compass'),
                'description' => __('Mention the URL of your Google here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            'compass_instagram' => array(
                'id' => 'compass_options[compass_instagram]',
                'label' => __('Instagram URL', 'compass'),
                'description' => __('Mention the URL of your Instagram Feed here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            'compass_twitter' => array(
                'id' => 'compass_options[compass_twitter]',
                'label' => __('Twitter URL', 'compass'),
                'description' => __('Mention the URL of your Twitter here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            'compass_youtube' => array(
                'id' => 'compass_options[compass_youtube]',
                'label' => __('Youtube URL', 'compass'),
                'description' => __('Mention the URL of your Youtube here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            'compass_tumblr' => array(
                'id' => 'compass_options[compass_tumblr]',
                'label' => __('Tumblr URL', 'compass'),
                'description' => __('Mention the URL of your Tumblr Feed here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
            'compass_flickr' => array(
                'id' => 'compass_options[compass_flickr]',
                'label' => __('Flickr URL', 'compass'),
                'description' => __('Mention the URL of your Flickr here.', 'compass'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            )
